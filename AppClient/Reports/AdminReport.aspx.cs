...
public partial class Reports_AdminReport : System.Web.UI.Page
{
    ...
    protected void btnViewReport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            _strpath = @"Reports/AdminReport.rdlc";
            ...
            dtAcivitySummary = reportService.AdminCheckinoutDetails(mAppManager.LoginUser.Id, DateTime.Parse(txtActivityFromDate.Text), DateTime.Parse(txtActivityToDate.Text), iClientIds, iUserids);
