<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AppMaster.master" AutoEventWireup="true"
    CodeFile="WorkedDuration.aspx.cs" Inherits="Reports_WorkedDuration" Theme="Classical" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="Server">
    <div>
        <div class="page-header-panel">
            <h2><asp:Label runat="server" ID="lblEmployeeCheckInOutDetails" Text="Employee Check In/Out Details"></asp:Label></h2>
        </div>
    ...
    <div>
        <%--<asp:Label Visible="false" ID="lblEmployeeCheckInOutDetails" runat="server"></asp:Label>--%>
        <asp:Label Visible="false" ID="lblworkdate" runat="server"></asp:Label>
        <asp:Label Visible="false" ID="lblUserWorkedDt" runat="server"></asp:Label>
    </div>
</asp:Content>
