...
AutoEventWireup="true" CodeFile="SwipeRegister.aspx.cs" Inherits="Reports_SwipeRegister" Theme="Classical"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="Server">
    <div>
        <div class="page-header-panel">
            <h2><asp:Label ID="lblSwipeRegisterBangalore" Text="Swipe Register - Bangalore" runat="server"></asp:Label></h2>
        ...
        <div class="searchButtons">
            <asp:Button ID="btnView" Text="Summary" runat="server" Font-Bold="true"
                OnClick="btnViewReport_Click" />
            
            <asp:Button ID="btnDetailReport" Text="Detail" runat="server" Font-Bold="true"
 ...
 <div>
        ...
        <asp:Label Visible="false" ID="lblSwipeDetails" runat="server"></asp:Label>
        
        <asp:Label Visible="false" ID="lblDepartment" runat="server"></asp:Label>
        <asp:Label Visible="false" ID="lblENTRYTHROUGH" runat="server"></asp:Label>
        <asp:Label Visible="false" ID="lblCARDEVENTDATE" runat="server"></asp:Label>
        <asp:Label Visible="false" ID="lblENTRYEXITTIME" runat="server"></asp:Label>
