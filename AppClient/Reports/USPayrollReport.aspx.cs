...
public partial class Reports_ActivitySummaryReportView : System.Web.UI.Page
{
    ...
    protected void btnView_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            _strpath = @"Reports\USPayrollrep.rdlc";
           ...
           this.DisplayMessage(string.Empty, false);
            ...
            dtAcivitySummary = reportService.RetrieveUSPayrollDeatilsReportData(txtFromDate.Text, txtToDate.Text, iClientIds, iProjectIds, mAppManager.LoginUser.Id, iUserIds, iLocationIds, iManagerIds, chkMiscellaneous.Checked, 1);
            ...
            if (dtAcivitySummary != null)
            {
                ...
                ReportParameter rp1 = new ReportParameter("Fromdate", lblFromDate.Text);
                ReportParameter rp2 = new ReportParameter("Todate", lblToDate.Text);
                ReportParameter rp3 = new ReportParameter("lblName", lblName.Text);
                ReportParameter rp4 = new ReportParameter("lblAlreadypaid", lblAlreadypaid.Text);
                ReportParameter rp5 = new ReportParameter("lblTotalhours", lblTotalhours.Text);
                ReportParameter rp6 = new ReportParameter("lblPTO", lblPTO.Text);
                ReportParameter rp13 = new ReportParameter("lblSick", lblSick.Text);
                ReportParameter rp11 = new ReportParameter("lblHoliday", lblHoliday.Text);
                ReportParameter rp8 = new ReportParameter("lblWrongHoliday", lblWrongHoliday.Text);
                ReportParameter rp9 = new ReportParameter("lblRegularHours", lblRegularHours.Text);
                ReportParameter rp10 = new ReportParameter("lblNightshift", lblNightshift.Text);
                ReportParameter rp12 = new ReportParameter("lblOT", lblOT.Text);
                ReportParameter rp7 = new ReportParameter("lblTobePaid", lblTobePaid.Text);
 ...
 * */
    ...
    protected void btnViewDetails_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataTable dtAcivitySummary = new DataTable();
            // Retrieve activity summary.
            dtAcivitySummary = reportService.RetrieveUSPayrollDeatilsReportData(txtFromDate.Text, txtToDate.Text, iClientIds, iProjectIds, mAppManager.LoginUser.Id, iUserIds, iLocationIds, iManagerIds, chkMiscellaneous.Checked,2);
