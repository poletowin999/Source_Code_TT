<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AppMaster.master"
    AutoEventWireup="true" CodeFile="SalaryRegister.aspx.cs" Inherits="Reports_SalaryRegister" Theme="Classical" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="Server">
    <div>
        <div class="page-header-panel">
            <h2><asp:Label ID="lblSalaryRegisterBangalore" Text="Salary Register - Bangalore" runat="server"></asp:Label></h2>
        </div>
            ...
            <ContentTemplate>
                <div class="searchFields">
                    <table cellspacing="0" border="0" class="tableLayout">
                        ...
                        <tr>
                            <td valign="top" colspan="3"><asp:Label runat="server" ID="lblLocations" Text="Locations:"></asp:Label>
                            </td>
                            <td colspan="5">
                            ...
                            <td></td>
                            <td valign="top" colspan="3"><asp:Label runat="server" ID="lblUsers" Text="Users:"></asp:Label>
                            </td>
                            <td colspan="5">
                                <div class="checkListBox">
    ...
    <div>
        ...
        <asp:Label Visible="false" ID="lblDOJ" runat="server"></asp:Label>
        ...
        <asp:Label Visible="false" ID="lblNoofDaysforthePeriod" runat="server"></asp:Label>
        <asp:Label Visible="false" ID="lblLOP" runat="server"></asp:Label>
        <asp:Label Visible="false" ID="lblDaystobePaidfor" runat="server"></asp:Label>
        <asp:Label Visible="false" ID="lblNSA" runat="server"></asp:Label>
        <asp:Label Visible="false" ID="lblOverTime" runat="server"></asp:Label>
