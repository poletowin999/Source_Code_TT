...
public partial class Reports_PayrollActivityReportView : System.Web.UI.Page
{
    ...
    protected void btnView_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            _strpath = @"Reports/PayrollActivityReport_LOB.rdlc";
            _strDatatablename = "DataSet1_RetrievepayrollActivityForDesign";
            ...
            dtAcivitySummary = reportService.RetrievePayrollActivity_LOB(mAppManager.LoginUser.Id, txtFromDate.Text, txtToDate.Text, iProjectIds, iBillTypeIds, iWorkTypeIds, iClientIds, iUserIds, iprojectClientIds);
            ...
            if (dtAcivitySummary != null)
            {
                ...
                ReportParameter rp12 = new ReportParameter("ClientName", lblclients.Text);
                ReportParameter rp13 = new ReportParameter("CategoryName", lblCategoryName.Text);
                ...
                ReportParameter rp14 = new ReportParameter("lblStatus", lblStatus.Text);
                ReportParameter rp15 = new ReportParameter("lblActivityLocation", lblActivityLocation.Text);
                ReportParameter rp16 = new ReportParameter("lblUserLocation", lblUserLocation.Text);
