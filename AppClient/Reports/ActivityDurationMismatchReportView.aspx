...
CodeFile="ActivityDurationMismatchReportView.aspx.cs" Inherits="Reports_ActivityDurationMismatchReportView"
 Theme="Classical"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
 <div>
        <div class="page-header-panel">
            <h2><asp:Label runat="server" ID="lblCheckInoutmismatchReport" Text="Check In/out mismatch with activity duration"></asp:Label></h2>
    ...
    <div>
       <asp:Label Visible="false" ID="lblName" runat="server"></asp:Label>
        ...
        <asp:Label Visible="false" ID="lblActivityDuration" runat="server"></asp:Label>
        <asp:Label Visible="false" ID="lblCheckInOut" runat="server"></asp:Label>
