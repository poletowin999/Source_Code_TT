...
public partial class Reports_ActivityDurationMismatchReportView : System.Web.UI.Page
{
    ...
    protected void btnViewReport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            _strpath = @"Reports/ActivityDurationMismatchReport.rdlc";
            _strDatatablename = "DataSet1_ActivityDurationMismatch";
            ...
            DataTable dtAcivityDuration = new DataTable();
            // Retrieve activity Duration Mismatch Details
            dtAcivityDuration = reportService.RetrieveActivityDurationMismatchDetails(mAppManager.LoginUser.Id, DateTime.Parse(txtActivityFromDate.Text), DateTime.Parse(txtActivityToDate.Text), iClientIds, iUserids);
            ...
            if (dtAcivityDuration != null)
            {
                ...
                ReportDataSource rds = new ReportDataSource(_strDatatablename, dtAcivityDuration);

                ReportParameter rp1 = new ReportParameter("lblName", lblName.Text);
                ReportParameter rp2 = new ReportParameter("LocationName", lblLocations.Text);
                ReportParameter rp3 = new ReportParameter("lblActivityDate", lblActivityDate.Text);
                ReportParameter rp4 = new ReportParameter("lblActivityDuration", lblActivityDuration.Text);
                ReportParameter rp5 = new ReportParameter("lblCheckInOut", lblCheckInOut.Text);
                ReportParameter rp6 = new ReportParameter("lblContractDays", lblContractDays.Text);
