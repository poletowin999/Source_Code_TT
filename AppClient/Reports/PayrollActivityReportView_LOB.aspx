<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AppMaster.master" AutoEventWireup="true"
    CodeFile="PayrollActivityReportView_LOB.aspx.cs" Inherits="Reports_PayrollActivityReportView"
    Theme="Classical" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="Server">
    <asp:UpdatePanel ID="UpdateActivitySummary" runat="server">
        <ContentTemplate>
            <div class="page-header-panel">
                <h2>
                    <asp:Label ID="lblBillingReportLOB" Text="Billing Report - LOB" runat="server"></asp:Label></h2>
                </h2>
            </div>
            <div>
            </div>
    ...
    <div>
        ...
        <asp:Label Visible="false" ID="lblActivityLocation" runat="server"></asp:Label>
        <asp:Label Visible="false" ID="lblUserLocation" runat="server"></asp:Label>
    </div>
