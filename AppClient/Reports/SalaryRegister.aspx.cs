...
public partial class Reports_SalaryRegister : System.Web.UI.Page
{
    ...
    protected void btnViewReport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            _strpath = @"Reports/SalaryRegister.rdlc";
            // _strpath = @"Reports/UserCheckInOutDetail.rdlc";
            _strDatatablename = "DtSalaryregister";
            ...
            dtAcivitySummary = reportService.RetrieveSalaryDetails(mAppManager.LoginUser.Id, DateTime.Parse(txtActivityFromDate.Text), DateTime.Parse(txtActivityToDate.Text), iClientIds, iUserids);
            ...
            if (dtAcivitySummary != null)
            {
                ...
                ReportParameter rp3 = new ReportParameter("EmpNo", lblEmpNo.Text);
                ReportParameter rp4 = new ReportParameter("Name", lblName.Text);
                ReportParameter rp5 = new ReportParameter("DOJ", lblDOJ.Text);
                ReportParameter rp6 = new ReportParameter("prmLocation", lblLocation.Text);
                ReportParameter rp7 = new ReportParameter("prmDesignation", lblDesignation.Text);
                ReportParameter rp8 = new ReportParameter("NoofDaysforthePeriod", lblNoofDaysforthePeriod.Text);
                ReportParameter rp9 = new ReportParameter("LOP", lblLOP.Text);
                ReportParameter rp10 = new ReportParameter("DaystobePaidfor", lblDaystobePaidfor.Text);
                ReportParameter rp11 = new ReportParameter("NSA", lblNSA.Text);
                ReportParameter rp12 = new ReportParameter("OverTime", lblOverTime.Text);
                ReportParameter rp13 = new ReportParameter("ContractDays", lblContractDays.Text);
                ReportParameter rp14 = new ReportParameter("SalaryRegisterBangalore", lblSalaryRegisterBangalore.Text);
                ReportParameter rp15 = new ReportParameter("lblFromDate", lblFromDate.Text);
                ReportParameter rp16 = new ReportParameter("lblToDate", lblToDate.Text);
