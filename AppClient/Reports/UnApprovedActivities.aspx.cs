...
public partial class Reports_UnApprovedActivities : System.Web.UI.Page
{
    ...
    protected void btnView_Click1(object sender, EventArgs e)
    {
        try
        {
            ...
            _strpath = @"Reports/UnApprovedActivities.rdlc";
            _strDatatablename = "DataSet1_UnApprovedActivities";
            ...
            DataTable UnapprovedActivities = new DataTable();
            // Retrieve activity summary.
            UnapprovedActivities = reportService.RetrieveUnApprovedAcitvities(DateTime.Parse(txtFromDate.Text), DateTime.Parse(txtToDate.Text), mAppManager.LoginUser.Id, iUserIds, iLocationIds);
            ...
            //{
                ...
                ReportDataSource rds = new ReportDataSource(_strDatatablename, UnapprovedActivities);

                ReportParameter rp1 = new ReportParameter("EmpNo", lblManager.Text);
                ReportParameter rp2 = new ReportParameter("lblName", lblName.Text);
                ReportParameter rp3 = new ReportParameter("lblActivityDate", lblActivityDate.Text);
                ReportParameter rp4 = new ReportParameter("lblTotalhours", lblTotalhours.Text);
                ReportParameter rp5 = new ReportParameter("lblContractDays", lblContractDays.Text);
                ReportParameter rp6 = new ReportParameter("lblUnApprovedActivities", lblUnApprovedActivities.Text);
