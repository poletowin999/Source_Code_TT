...
public partial class Reports_PayrollActivityReportView : System.Web.UI.Page
{
    ...
    protected void btnView_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            _strpath = @"Reports/PayrollActivityReport.rdlc";
            ...
            dtAcivitySummary = reportService.RetrievePayrollActivity(mAppManager.LoginUser.Id, txtFromDate.Text, txtToDate.Text, iProjectIds, iBillTypeIds, iWorkTypeIds, iClientIds, iUserIds, iprojectClientIds);
