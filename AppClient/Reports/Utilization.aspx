<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AppMaster.master" AutoEventWireup="true"
    CodeFile="Utilization.aspx.cs" Inherits="Reports_UtilizationReportView"
    Theme="Classical" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="Server">
    <asp:UpdatePanel ID="UpdateActivitySummary" runat="server">
        <ContentTemplate>
            <div class="page-header-panel">
                <h2>
                    <asp:Label ID="lblUtilizationReport" Text="Utilization Report" runat="server"></asp:Label>
                </h2>
            </div>
            <div>
            </div>
    ...
    <div class="commandPanel">
        <asp:Button ID="btnView" Text="Detail" runat="server" Font-Bold="true"
            OnClick="btnView_Click" />
                <asp:Button ID="btnDetailReport" Text="View" runat="server" Font-Bold="true"
            OnClick="btnView_Click_detail" />
    ...
    <div>
        <asp:Label Visible="false" ID="lblDesignation" Text="Designation" runat="server"></asp:Label>
        ...
        <asp:Label Visible="false" ID="lblworkdate" runat="server"></asp:Label>
        <asp:Label Visible="false" ID="lblBillable" runat="server"></asp:Label>
        <asp:Label Visible="false" ID="lblTotalhours" runat="server"></asp:Label>
        <asp:Label Visible="false" ID="lblNonBillable" runat="server"></asp:Label>
        <asp:Label Visible="false" ID="lblUtilizationReportDetail" runat="server"></asp:Label>
       
         <asp:Label Visible="false" ID="lblDescription" runat="server"></asp:Label>
        <asp:Label Visible="false" ID="lblIncludingStudio" runat="server"></asp:Label>
        <asp:Label Visible="false" ID="lblexcludingStudio" runat="server"></asp:Label>
        <asp:Label Visible="false" ID="lblStudio" runat="server"></asp:Label>
